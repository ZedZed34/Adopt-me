<script>
  ...
  let images = [
    "/src/lib/image/defaultPP-cat.png",
    "/src/lib/image/defaultPP-dog.png",
    "/src/lib/image/defaultPP-hamster.png",
    "/src/lib/image/defaultPP-duck.png",
    "/src/lib/image/defaultPP-pig.png"
  ];
  let currentImage = 0;
  function nextImage() {
  ...
  {#if showDeactivateAccount}
    <div class="pop-up-deactivate">
      <div id="deactivateinfo-container">
        ...
        <p id="deactivate">
          *Once you deactivate your account, all your personal account information will be cleared
          and cannot be retrieved, including all articles and comments you published.
        </p>
      </div>
      <button on:click={toggleDeactivateAccount}
        ><a href="/ProfilePage/ProfilePageDeactivate">Yes</a></button
      >
